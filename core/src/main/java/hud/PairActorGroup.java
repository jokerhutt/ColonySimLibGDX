...
public class PairActorGroup extends Group {
    ...
    public PairActorGroup (GameScreen screen, String imagePath, String mainText, int dynamicValue, String finalText, char imageSize, float fontSize) {
        ...
        if (dynamicValue != -1) {
            ...
            groupLabel.setPosition(
                groupImage.getWidth() + 10,
                ((groupImage.getHeight() - groupLabel.getHeight()) / 2f) - 4f
            );
