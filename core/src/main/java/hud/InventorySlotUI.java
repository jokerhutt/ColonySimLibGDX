...
public class InventorySlotUI extends Stack {
    ...
    public InventorySlotUI(GameItem inventoryItem) {

        brownSquare = new Texture("brown.png");
        brownSquareSelected = new Texture("brownSelect.png");
    ...
    public void updateItem(GameItem newInventoryItem) {
        if (itemImage != null) {
